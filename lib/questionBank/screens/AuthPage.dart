...
class _SignUpPageState extends State<SignUpPage> {
      ...
      body: Stack(
        ...
        children: <Widget>[    
          Center(
            ...
            (isLoading)?BackdropFilter(filter: ImageFilter.blur(sigmaX: 1, sigmaY: 1),child: Container(color:Colors.black54,child: Center(child: Loading(indicator: BallGridPulseIndicator(),color: Colors.amberAccent)))):SizedBox.shrink(),
        ],
      ),
    );
  }
  ...
  _showErrorDialog(context)
  {
    ...
    {
      return AlertDialog(title:Text("Failed to autenticate, try again"),actions: <Widget>[FlatButton(child: Text("close",),onPressed: (){Navigator.pop(context);},)],);
    });
  }
}
